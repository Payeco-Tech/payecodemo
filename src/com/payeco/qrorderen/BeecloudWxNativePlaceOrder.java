...
public class BeecloudWxNativePlaceOrder {
	public static void main(String[] args) {
		new BeecloudWxNativePlaceOrder().assemble("","","");
	}
	...
	public String assemble(String amount, String merchantNo, String merchantPwd){
		...
		try {
			...
			if(Toolkit.isNullOrEmpty(merchantPwd)) merchantPwd = "DCB9F4B6F62B4D25";//密钥
			...
			if(Toolkit.isNullOrEmpty(merchantNo))  merchantNo = "502020002975";
