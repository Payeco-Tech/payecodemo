...
public class AliScanBarPlaceOrder {
	/**
	 * 扫码下单demo，返回格式为xml
	 */
	public String assemble(String authCode, String amount, String merchantNo, String merchantPwd){
		...
		try {
			...
			if(Toolkit.isNullOrEmpty(merchantPwd)) merchantPwd = "8DEAA6A6B0E14290";//密钥
			...
			if(Toolkit.isNullOrEmpty(merchantNo)) merchantNo = "502020002899";
			...
			//新增订单来源
			msg.setOrderFrom("39");		//30扫码
			msg.setTransData("|00|00|"+authCode+"|");
